...
*/
        ...
        for(int i = 0; i < str.length(); i++){
            ...
            if(count == 1){ // the counter will be one when the character was unique.
                // the character will always match with itself one time, so it will never be 0,
                // but if the counter value is more than 1 then that character matched with multiple other characters,
