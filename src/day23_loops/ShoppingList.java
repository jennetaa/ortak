...
*/
        ...
        } while (addMore.equalsIgnoreCase("yes") || addMore.equalsIgnoreCase("ok")); // if the user types 'yes' in the console about wanting to add more items, then the loop will iterate again
